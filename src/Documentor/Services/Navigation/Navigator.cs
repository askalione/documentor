...
namespace Documentor.Services.Navigation
{
    ...
    {
        private readonly ILogger<PerRequestNavigator> _logger;
        ...
        public PerRequestNavigator(ILogger<PerRequestNavigator> logger,
            ...
            IPageIOManager pageIOManager)
        {
            ...
            _directoryScanRegex = new Regex($@"^(0*)([0-9]+)\{Separator.Sequence}(.*)", RegexOptions.Compiled | RegexOptions.IgnoreCase);
        }
