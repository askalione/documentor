...
using Documentor.Framework.Utils;
...
namespace Documentor.Services.Pages
{
    public class Pager : IPager
    {
        ...
        public async Task AddPageAsync(PageAddCommand command)
        {
            ...
            {
                Regex regex = new Regex($@"^(0*)([0-9]+)\{Separator.Sequence}{command.VirtualName}", RegexOptions.Compiled | RegexOptions.IgnoreCase);
        ...
        public void MovePage(PageMoveCommand command)
        {
            ...
            Regex regex = new Regex($@"^(0*)([0-9]+)\{Separator.Sequence}(.*)", RegexOptions.Compiled | RegexOptions.IgnoreCase);
        ...
        private Location GetLocation(string virtualPath)
        {
            ...
            {
                Regex regex = new Regex($@"^(0*)([0-9]+)\{Separator.Sequence}{virtualNamesForScan.Pop()}", RegexOptions.Compiled | RegexOptions.IgnoreCase);
