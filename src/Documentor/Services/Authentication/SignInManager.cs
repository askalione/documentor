...
namespace Documentor.Services.Authentication
{
    public class SignInManager : ISignInManager
    {
        ...
        public SignInManager(IOptionsSnapshot<AuthorizationSettings> settingsOptions,
            ...
            IAuthenticationSchemeProvider schemes)
        {
            ...
            _authorizationSettings = settingsOptions.Value;
        ...
        public async Task<SignInResult> TrySignInAsync(bool isPersistent)
        {
            ...
            if (string.IsNullOrWhiteSpace(email) || !_authorizationSettings.Emails.Contains(email))
